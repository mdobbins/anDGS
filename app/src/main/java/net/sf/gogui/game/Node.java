    ...
    implements ConstNode
{
    ...
    */
    ...
    @return Index of child or -1, if node is not a child of this node.
     */
	public void replaceChildAtIndex(int indx, Node node)
	{
		assert node.m_father == null;
        if (m_children == null)
        {
        ...
        else
        {
            ...
            else
            {
            	...
            	oldNode = list.set(indx, node); 
            	oldNode.m_father = null;
            	
            }
            // TODO handle? other children of the removed node "oldNode"  
        }
        node.m_father = this;
	}
